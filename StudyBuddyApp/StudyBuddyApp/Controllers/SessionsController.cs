...
namespace StudyBuddyApp.Controllers
{
    public class SessionsController : Controller
    {
        ...
        {
            var appDbContext = _context.Sessions.Include(s => s.StudyGroup);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SessionId,GroupId,Topic,StartTime,Location")] Session session)
        {
